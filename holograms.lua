...
function Holograms()
		while true do
			Citizen.Wait(0)			
				-- Hologram No. 1
		if GetDistanceBetweenCoords( -262.27, -969.58, 33.55, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
			...
			Draw3DText( -262.27, -969.58, 33.55  -1.800, "your server name", 4, 0.1, 0.1)	-- Location Job Centre	
				...
				--Hologram No. 2
		if GetDistanceBetweenCoords( -266.68, -968.37, 32.04, GetEntityCoords(GetPlayerPed(-1))) < 10.0 then
